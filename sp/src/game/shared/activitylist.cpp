...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY( ACT_VM_RECOIL1_LEFT );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RECOIL2_LEFT );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RECOIL3_LEFT );
	...
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_SMG1 );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_AR2 );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_RPG );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_CROSSBOW );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_MELEE );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_SLAM );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_AR1 );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_AR3 );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_SMG2 );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_SMG3 );
