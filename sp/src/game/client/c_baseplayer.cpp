...
#ifdef EZ2
	RecvPropBool	(RECVINFO(m_bDuckSliding)),
	RecvPropFloat	(RECVINFO(m_flDuckSlideTime)),
	RecvPropFloat	(RECVINFO(m_flDuckSlideEndTime)),
#endif
...
#ifdef EZ2
	DEFINE_PRED_FIELD( m_bDuckSliding, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( m_flDuckSlideTime, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
	DEFINE_PRED_FIELD( m_flDuckSlideEndTime, FIELD_FLOAT, FTYPEDESC_INSENDTABLE ),
#endif
