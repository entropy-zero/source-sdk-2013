...
//===========================
	...
	ADD_ACTIVITY_TO_SR( ACT_VM_RECOIL1_LEFT );
	ADD_ACTIVITY_TO_SR( ACT_VM_RECOIL2_LEFT );
	ADD_ACTIVITY_TO_SR( ACT_VM_RECOIL3_LEFT );
	...
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SLIDE_SMG1 );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SLIDE_AR2 );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SLIDE_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SLIDE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SLIDE_RPG );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SLIDE_CROSSBOW );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SLIDE_MELEE );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SLIDE_SLAM );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SLIDE_AR1 );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SLIDE_AR3 );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SLIDE_SMG2 );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SLIDE_SMG3 );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SLIDE_HMG1 );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SLIDE_SNIPER_RIFLE );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SLIDE_DUAL_PISTOLS );

	ADD_ACTIVITY_TO_SR( ACT_GESTURE_GLIDE );
	ADD_ACTIVITY_TO_SR( ACT_GESTURE_JUMP );
#endif
}
